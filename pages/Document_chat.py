...
def get_conversation_chain(vectorstore):
    ...
    conversation_chain = ConversationalRetrievalChain.from_llm(
        llm=ChatOpenAI(temperature=0, model_name=model_select),
...
if on:
    ...
    db = Chroma (persist_directory=r"D:\RAG CHAT APP OPEN AI-20240129T061316Z-001\RAG CHAT APP OPEN AI\pages\db", embedding_function = embeddings)
